  ...
  <div class="container">
    ...
    <table>
      <tr>
        ...
        <th>No of Pages</th><th>Price</th><th>Publish Date</th><th>ISBN</th><th>Delete</th>
      </tr>
      <?php foreach ($info as $val){ ?>
        <tr>
          ...
          <td><a href="10.delete_process.php?id=<?= urlencode($val['id']) ?>">Delete</a></td>
        </tr>
      <?php } ?>
    </table>
  </div>
